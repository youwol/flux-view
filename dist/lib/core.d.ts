...
import { AttributeType } from "./stream$";
export interface VirtualDOM {
    tag?: string;
    [key: string]: any;
}
declare const HTMLElement$_base: {
    new (...args: any[]): {
        vDom: VirtualDOM;
        subscriptions: Subscription[];
        initialize(vDom: VirtualDOM): void;
        connectedCallback(): void;
        disconnectedCallback(): void;
        applyAttribute(name: string, value: AttributeType): void;
        accessKey: string;
...
declare class HTMLElement$ extends HTMLElement$_base {
}
export declare function render(vDom: VirtualDOM): HTMLElement$;
export {};
